...
% Last Modified by GUIDE v2.5 05-May-2020 09:56:59
...
% --- Executes on button press in inputDataAlternatif.
function inputDataAlternatif_Callback(hObject, eventdata, handles)
% hObject    handle to inputDataAlternatif (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
close(Menu);
run('InputDataAlternatif');

% --- Executes on button press in inputKriteria.
function inputKriteria_Callback(hObject, eventdata, handles)
% hObject    handle to inputKriteria (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
close(Menu);
run('InputKriteria');
